#  :bar_chart: :chart_with_upwards_trend: An Introduction to SDS: Lecture Nine :chart_with_downwards_trend: :bar_chart:	
...
In this lecture, we'll talk about a more advanced introduction to Network Science using the [network-x](https://networkx.org/) library.
