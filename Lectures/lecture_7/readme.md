#  :bar_chart: :chart_with_upwards_trend: An Introduction to SDS: Lecture Seven :chart_with_downwards_trend: :bar_chart:	
...
In this lecture, we'll talk about some more advanced applications of Natural Language Processing using the [nltk](https://www.nltk.org/) library.
